...
" Linebreak on (no 500) 80 characters
set lbr
set tw=80
...
" Set line numbers in the left
set number
set relativenumber

" Setting the default clipboard buffer to the *+ so it can be easy copy outside terminal
set clipboard=unnamedplus

" When using git difftools ignore all white spaces
set diffopt+=iwhiteall

" When folding use indent
set foldmethod=indent

" Smart wrapping for easier read of code
set bri
